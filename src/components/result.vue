<template>
     <div class="result" v-if="videosInfo.hasOwnProperty(item.id.videoId)">
          ...
          <div class="result__info">
               ...
               <div class="video">
                    <p class="align-content video__channel-title">
                         {{videosInfo[item.id.videoId].items[0].snippet.channelTitle}}</p>
                    <div class="dot-separator">&#8226;</div>
                    <p class="align-content video__views">{{videosInfo[item.id.videoId].items[0].statistics.viewCount |
                         changeCountExpression}}</p>
                    <div class="dot-separator">&#8226;</div>
                    <p class="align-content video__publish">{{videosInfo[item.id.videoId].items[0].snippet.publishedAt |
                         publishPeriod}}</p>
               </div>
